...
```
$ docker run --name winecellar -p 5432:5432 -d -e POSTGRES_USER=winecellar -e POSTGRES_PASSWORD=winecellar -e POSTGRES_DB=winecellar postgres:9.4
```
> This will pull down the PostgreSQL v9.4 image and run the container with all necessary Spring Boot properties for connection. 
